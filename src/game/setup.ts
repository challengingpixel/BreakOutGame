...
export function setupEntities(world: World, canvas: HTMLCanvasElement): void {
...
export function resetBall(world: World, canvas: HTMLCanvasElement): void {
...
export function resetPaddle(world: World, canvas: HTMLCanvasElement): void {
